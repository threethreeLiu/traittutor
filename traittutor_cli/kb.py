...
from traittutor.services.rag.factory import DEFAULT_PROVIDER
...
def register(app: typer.Typer) -> None:
    ...
    def kb_create(
        ...
        from traittutor.knowledge.initializer import initialize_knowledge_base
    ...
    def kb_add(
        ...
        from traittutor.knowledge.add_documents import add_documents
