...
from traittutor.services.sandbox.backends import BwrapBackend, RestrictedSubprocessBackend
from traittutor.services.sandbox.config import SandboxSettings, build_backend
from traittutor.services.sandbox.quota import QuotaExceeded, UserExecQuota
from traittutor.services.sandbox.service import SandboxService
from traittutor.services.sandbox.spec import ExecRequest, ExecResult, IsolationLevel, ResourceLimits


def test_backend_selection_runner_url() -> None:
    from traittutor.services.sandbox.backends import RunnerSidecarBackend
...
def test_backend_selection_none_without_optin() -> None:
    ...
    from traittutor.services.sandbox.backends import RestrictedSubprocessBackend
...
def test_runner_server_validates_request_shape() -> None:
    from traittutor.services.sandbox.runner import server
