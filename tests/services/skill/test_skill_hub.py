...
def test_clawhub_catalog_normalises_rows() -> None:
    ...
    assert row["owner_url"] == "https://traittutor.info"
...
def test_clawhub_detail_includes_body_version_and_tags() -> None:
    ...
    assert detail["owner"] == "TraitTutor"  # lifted from the envelope top level


def test_clawhub_web_origin_strips_api_suffix() -> None:
    provider = ClawHubProvider("eduhub", base_url="https://eduhub.traittutor.info/api/v1")
    assert provider.web_origin == "https://eduhub.traittutor.info"
