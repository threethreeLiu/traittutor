...
async def run_test(
    *,
    ...
    from traittutor.services.llm import config as config_module
    ...
    try:
        from traittutor.services.llm.factory import complete

        t0 = time.perf_counter()
        resp = await complete(
            "Reply with exactly: HELLO_TRAITTUTOR",
    ...
    if test_stream:
        ...
        try:
            from traittutor.services.llm.factory import stream
