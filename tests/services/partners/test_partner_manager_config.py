...
from traittutor.services.partners.manager import PartnerConfig, PartnerManager
from traittutor.services.partners.workspace import DEFAULT_SOUL, read_soul
