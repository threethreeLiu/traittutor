...
from traittutor.partners.channels import mattermost as mm_module
from traittutor.partners.channels.mattermost import MattermostChannel, MattermostConfig
