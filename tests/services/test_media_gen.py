...
from traittutor.services.videogen.adapters.async_task import AsyncTaskVideogenAdapter
...
async def test_imagegen_tool_saves_public_artifact(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    import traittutor.services.imagegen as imagegen_mod
...
async def test_videogen_tool_forwards_progress_and_saves(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from traittutor.services.path_service import get_path_service
    import traittutor.services.videogen as videogen_mod
    from traittutor.tools.media_gen_tool import VideogenTool
