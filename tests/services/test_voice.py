...
from traittutor.services.voice import synthesize_speech, transcribe_audio
from traittutor.services.voice.adapters.openai_compat import (
...
async def test_tts_adapter_raises_on_http_error(monkeypatch: pytest.MonkeyPatch) -> None:
    from traittutor.services.voice.base import VoiceProviderError
