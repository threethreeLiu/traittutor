...
from traittutor.services.cron.service import CronService
from traittutor.tools.cron_tool import run_cron_action


@pytest.fixture
def cron_service(tmp_path, monkeypatch):
    import traittutor.services.cron.service as service_mod
    import traittutor.tools.cron_tool as tool_mod
...
class TestExecutorRouting:
    ...
    async def test_partner_job_runs_and_publishes_outbound(self, monkeypatch):
        from traittutor.services.cron import executor
        from traittutor.services.cron.service import CronJob, CronOwner, CronSchedule
        ...
        import traittutor.services.partners as partners_mod
