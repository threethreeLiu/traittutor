...
from traittutor.agents.math_animator.capability import MathAnimatorCapability
...
async def test_math_animator_capability_emits_summary_and_result(
    ...
    monkeypatch.setattr(
        "traittutor.agents.math_animator.capability.importlib.util.find_spec",
    ...
    monkeypatch.setattr(
        "traittutor.agents.math_animator.pipeline.MathAnimatorPipeline", FakePipeline
    )
    monkeypatch.setattr(
        "traittutor.services.llm.config.get_llm_config",
