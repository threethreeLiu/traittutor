...
from traittutor.multi_user.grants import load_grant, normalize_grant, save_grant
from traittutor.multi_user.tool_access import (
    allowed_mcp_tools,
...
def grantable_alice(mu_isolated_root, monkeypatch):
    ...
    from traittutor.multi_user import grants
