...
from traittutor.multi_user import partner_access
from traittutor.multi_user.grants import empty_grant, normalize_grant
...
def _patch_manager(monkeypatch, partners: list[dict]) -> None:
    import traittutor.services.partners as pkg
...
def test_admin_partner_summary_is_identity_only(monkeypatch):
    from traittutor.multi_user import router
