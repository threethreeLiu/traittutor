"""CLI smoke tests for ``traittutor notebook`` commands."""
...
def _patch_facade(monkeypatch) -> None:
    """Patch TraitTutorApp methods to use the shared fake manager."""
    ...
    from traittutor.app import facade

    monkeypatch.setattr(facade.TraitTutorApp, "create_notebook", _create_notebook)
    monkeypatch.setattr(facade.TraitTutorApp, "get_notebook", _get_notebook)
    monkeypatch.setattr(facade.TraitTutorApp, "add_record", _add_record)
    monkeypatch.setattr(facade.TraitTutorApp, "update_record", _update_record)
    monkeypatch.setattr(facade.TraitTutorApp, "remove_record", _remove_record)
