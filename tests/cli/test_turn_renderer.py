...
The chat agent loop (traittutor/agents/chat/agent_loop.py) streams every
...
from traittutor.app import TurnRequest
from traittutor_cli import common as cli_common
from traittutor_cli.common import _resolve_answer
...
def _install_fake_runtime(
    ...
    *,
    ...
    monkeypatch.setattr("traittutor.app.facade.TraitTutorApp.submit_user_reply", _submit_user_reply)
