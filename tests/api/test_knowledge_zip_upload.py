...
from traittutor.api.routers.knowledge import _save_uploaded_files
...
def _disable_pocketbase(monkeypatch):
    monkeypatch.setattr("traittutor.services.pocketbase_client.is_pocketbase_enabled", lambda: False)
