...
memory_router = importlib.import_module("traittutor.api.routers.memory").router
paths_mod = importlib.import_module("traittutor.services.memory.paths")
document_mod = importlib.import_module("traittutor.services.memory.document")
