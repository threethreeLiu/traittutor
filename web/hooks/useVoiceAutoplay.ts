...
const SESSION_KEY_PREFIX = "traittutor.voiceAutoplay.session"; // "on" | "off"
const PROMPTED_KEY_PREFIX = "traittutor.voiceAutoplay.prompted"; // "1"
const GLOBAL_EVENT = "traittutor:voice-autoplay-global";
const SESSION_EVENT = "traittutor:voice-autoplay-session";
