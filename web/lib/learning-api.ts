...
// Mirrors traittutor/learning/policy.py map_summary + next_objective.
...
export interface ProgressSummary {
  ...
  kp_count: number;
  current_stage: string;
  evidence_state_counts: Partial<Record<"insufficient_evidence" | "needs_support" | "developing" | "supported", number>>;
  updated_at: number;
  /** Server-derived availability only; subject/KC details never leave the API. */
