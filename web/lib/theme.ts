...
export type Theme = "light" | "dark" | "snow" | "teal";

export const THEME_STORAGE_KEY = "traittutor-theme";
 ...
 * TraitTutor uses Snow as the product default. This must stay in sync with
...
export function applyThemeToDocument(theme: Theme): void {
  ...
  html.classList.remove("dark", "theme-snow", "theme-teal");
  ...
  if (theme === "dark") {
    ...
    html.classList.add("theme-teal");
  }
}

/**
 * Initialize theme on app startup
 * Priority: localStorage > product default (Snow)
 */
