...
export const ACTIVE_SESSION_STORAGE_KEY = "traittutor.activeSessionId.tab";
export const LANGUAGE_STORAGE_KEY = "traittutor-language";
export const SIDEBAR_COLLAPSED_STORAGE_KEY = "traittutor.sidebarCollapsed";
export const CHAT_RESPONSE_TIMEOUT_STORAGE_KEY =
  "traittutor.chatResponseTimeout";
export const CODE_BLOCK_THEME_STORAGE_KEY = "traittutor.code-block-theme";
export const CODE_BLOCK_SHOW_LINE_NUMBERS_STORAGE_KEY =
  "traittutor.code-block-show-line-numbers";
export const CODE_BLOCK_WRAP_LONG_LINES_STORAGE_KEY =
  "traittutor.code-block-wrap-long-lines";
...
export const ACTIVE_SESSION_EVENT = "traittutor:active-session";
export const LANGUAGE_EVENT = "traittutor:language";
export const SIDEBAR_COLLAPSED_EVENT = "traittutor:sidebar-collapsed";
export const CODE_BLOCK_SETTINGS_EVENT = "traittutor:code-block-settings";
