...
const SPLIT_RATIO_KEY = "traittutor.co_writer.split_ratio";
const SYNC_SCROLL_KEY = "traittutor.co_writer.sync_scroll";
const LOCAL_DRAFT_PREFIX = "traittutor.co_writer.draft.";
