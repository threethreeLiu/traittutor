...
const PIP_HINT: Record<string, string> = {
  docling: "pip install traittutor[parse-docling]",
  markitdown: "pip install traittutor[parse-markitdown]",
  pymupdf4llm: "pip install traittutor[parse-pymupdf4llm]",
};
  ...
  return (
    ...
    >
      <SettingRow
        ...
        description={t(
          "Reserved — uses TraitTutor's vision model to caption images during conversion.",
        )}
        control={
          <Toggle
            checked={llmImages}
