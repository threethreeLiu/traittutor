      ...
      >
        <div className="py-4">
          ...
          <p className="mt-4 text-[11.5px] leading-relaxed text-[var(--muted-foreground)]/80">
            {t(
              "Cream is warm and paper-like with a terracotta accent — the TraitTutor brand theme. Snow is a clean pure-white theme with a blue accent. Dark keeps Cream's warmth on near-black. Glass adds translucent purple panels on a deep gradient.",
            )}
          </p>
        </div>
      </SettingSection>
