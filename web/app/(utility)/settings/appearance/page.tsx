...
export default function AppearanceSettingsPage() {
  ...
  return (
    <div data-tour="tour-appearance">
      ...
      >
        <div className="py-4">
          {/* Snow is the product default, followed by alternate palettes. */}
          ...
          <p className="mt-4 text-[11.5px] leading-relaxed text-[var(--muted-foreground)]/80">
            {t(
              "Snow is the clean white default with a blue accent. Cream is warm and paper-like with a terracotta accent. Dark keeps Cream's warmth on near-black. Teal brings a calm blue-green accent to a pale mint canvas.",
            )}
          </p>
        </div>
      </SettingSection>
