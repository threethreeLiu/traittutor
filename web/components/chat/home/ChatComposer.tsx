...
export default memo(function ChatComposer({
  ...
  /** Max times TraitTutor may consult the selected agent this turn. */
  ...
  return (
    <div
      ref={composerRef}
      className={`relative z-20 mx-auto w-full shrink-0 px-6 pb-5 ${hasMessages ? "pt-1 max-w-[960px]" : "max-w-[768px] pt-3"}`}
      style={{
