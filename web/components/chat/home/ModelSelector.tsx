  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        aria-expanded={open}
        className={`inline-flex h-8 w-8 max-w-[32px] shrink-0 items-center justify-center gap-1.5 rounded-lg px-2 text-[13px] font-medium transition-[background-color,color,transform] duration-150 active:scale-[0.97] sm:w-auto sm:max-w-[230px] sm:justify-start ${
          disabled
