 ...
 * can also dismiss manually. Informational updates are polite status messages;
 * errors are assertive alerts so assistive tech announces failures promptly.
 */
    ...
    <div className="pointer-events-none fixed bottom-6 right-6 z-[200] flex flex-col gap-2">
      {toasts.map((toast) => (
        <div
          ...
          aria-atomic="true"
          data-notification-tone={toast.tone}
