...
- Objective mode:
  ...
  - If the chunks only state a broad objective and provide no teachable facts, produce questions about interpreting, decomposing, or applying that stated objective rather than pretending the missing lesson content exists.
