...
# Mutable ContextVar defaults leak state between tasks; None + explicit
# empty-dict reads keep each context independent (B039).
_context: contextvars.ContextVar[dict[str, Any] | None] = contextvars.ContextVar(
    "traittutor_log_context", default=None
)
