...
_CONFIGURED = False
_MANAGED_ATTR = "_traittutor_managed"
...
def configure_logging(force: bool = False) -> LoggingConfig:
    ...
    logging.getLogger("traittutor").setLevel(logging.DEBUG)
    logging.getLogger("traittutor").propagate = True
