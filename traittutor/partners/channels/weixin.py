...
from traittutor.partners.config.paths import get_media_dir, get_runtime_subdir
from traittutor.partners.config.schema import DeliveryOverrides
from traittutor.partners.helpers import safe_filename, split_message
...
class WeixinChannel(BaseChannel):
    ...
    async def _send_text(
        ...
        client_id = f"traittutor-{uuid.uuid4().hex[:12]}"
