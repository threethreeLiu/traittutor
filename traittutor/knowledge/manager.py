...
class KnowledgeBaseManager:
    ...
    def __init__(self, base_dir="./data/knowledge_bases"):
        ...
        from traittutor.services.pocketbase_client import is_pocketbase_enabled
    ...
    def _sync_kb_to_pb(self, name: str, kb_entry: dict) -> None:
        ...
        if not self._pb_enabled:
            return
        try:
            from traittutor.services.pocketbase_client import get_pb_client
    ...
    def set_default(self, name: str):
        ...
        try:
            from traittutor.services.config import get_kb_config_service
