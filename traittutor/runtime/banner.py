...
from traittutor.__version__ import __version__

_ASCII_LOGO = r""" _____             _  _    _____        _
|_   _| _ __   __ _ (_)| |_ |_   _| _   _ | |_   ___   _ __
  | |  | '__| / _` || || __|  | |  | | | || __| / _ \ | '__|
  | |  | |   | (_| || || |_   | |  | |_| || |_ | (_) || |
  |_|  |_|    \__,_||_| \__|  |_|   \__,_| \__| \___/ |_|"""
...
LABELS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "start.port_in_use": (
            "TraitTutor cannot start because port(s) already in use: {ports}. "
...
def render_banner(language: str | None, *, mode_key: str | None = None) -> Panel:
    ...
    return Panel(
        Align.left(body),
        title="[bold bright_cyan]TraitTutor[/]",
