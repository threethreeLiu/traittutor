...
from traittutor.core.tool_protocol import BaseTool
...
class DeferredToolLoader:
    ...
    def __init__(
        ...
        *,
        ...
        # loadable pool from the current user's configured MCP grant.
    ...
    def _persist(self) -> None:
        try:
            from traittutor.services.mcp.session_state import record_loaded_tools
