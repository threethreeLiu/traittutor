...
from traittutor.core.capability_protocol import BaseCapability
from traittutor.i18n.metadata_i18n import capability_description_i18n
...
def _load_plugin_hooks():
    try:
        module = importlib.import_module("traittutor.plugins.loader")
    except Exception:
