...
def _concat_l3() -> str:
    ...
    """
    from traittutor.services.memory import get_memory_store, paths
...
def _resolve_partner_id() -> str | None:
    ...
    from traittutor.services.partners.scope import PARTNER_USER_PREFIX
...
class PartnerReadTool(BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from traittutor.multi_user.paths import (
            get_admin_path_service,
            get_current_path_service,
        )
        from traittutor.services.memory import memory_path_service_override
...
class PartnerMemorizeTool(BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        ...
        from traittutor.services.memory import get_memory_store, memory_path_service_override
