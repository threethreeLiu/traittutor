...
input_format: No parameters. Returns all four L3 documents concatenated.
...
note: When the user hasn't built up memory yet, returns a `(No memory available...)`
  notice — treat as a generic question.
phase: exploration
---
