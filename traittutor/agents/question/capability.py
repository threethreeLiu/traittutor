...
class DeepQuestionCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        ...
        if isinstance(followup_question_context, dict) and followup_question_context.get(
            ...
            from traittutor.agents.question.agents.followup_agent import FollowupAgent
        ...
        if mode != "mimic":
            ...
            from traittutor.agents.question.history import load_session_quiz_history
            from traittutor.agents.question.pipeline import QuestionPipeline
            from traittutor.agents.question.request_config import (
    ...
    async def _run_mimic_mode(
        ...
        * ``[Attached Documents]`` in  → no paper available; fall back to
        ...
        """
        from traittutor.agents.question.history import load_session_quiz_history
        from traittutor.agents.question.mimic_source import (
        ...
        from traittutor.services.config import load_config_with_main
        from traittutor.services.parsing.engines.mineru.config import MinerUError
