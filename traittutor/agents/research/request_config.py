...
Tool composition lives in :mod:`traittutor.agents._shared.tool_composition`
...
def build_research_runtime_config(
    *,
    ...
    runtime_config["reporting"] = dict(policy["reporting"])
...
def _build_mode_policy(mode: ResearchMode, depth: ResearchDepth) -> dict[str, Any]:
    from traittutor.agents.research.mode_strategy import get_strategy
