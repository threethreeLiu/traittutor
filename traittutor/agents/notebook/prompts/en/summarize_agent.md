...
record_hints:
  ...
  co_writer: A Co-Writer markdown draft authored by the user; focus on the document's
    topic, structure, current completion state, and what makes it worth revisiting.
