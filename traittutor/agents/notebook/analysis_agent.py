...
from traittutor.core.trace import build_trace_metadata, derive_trace_metadata, new_call_id
...
from traittutor.services.prompt.manager import get_prompt_manager
...
class NotebookAnalysisAgent:
    ...
    def __init__(self, language: str = "en") -> None:
        ...
        # Prompts come from traittutor/prompts/agents/notebook/{en,zh}/analysis_agent.md
    ...
    async def _stage_observing(
        ...
        *,
        ...
        async for chunk in self._stream_gateway(
            ...
            temperature=0.2,
            max_tokens=1200,
            purpose="agent:notebook-analysis:observing",
        ):
            if not chunk:
                continue
            chunks.append(chunk)
