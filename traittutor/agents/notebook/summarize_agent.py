...
class NotebookSummaryCancelled(Exception):
    """Abort a summary before a caller can persist an incomplete record."""
...
class NotebookSummarizeAgent:
    ...
    def __init__(self, language: str = "en") -> None:
        ...
        # Prompts live under traittutor/prompts/agents/notebook/{en,zh}/summarize_agent.md
        ...
        *,
        ...
        async for event in get_gateway().stream(request):
            if event.type == "text" and event.text:
                ...
                raise NotebookSummaryCancelled("Notebook summary stream cancelled")
