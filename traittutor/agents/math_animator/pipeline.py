...
class MathAnimatorPipeline:
    ...
    async def run_render(
        ...
        *,
        ...
        review_callback: Callable[[str, RenderResult], Awaitable[VisualReviewResult]] | None = None
        visual_review_agent = self.visual_review_agent
        if self.enable_visual_review and visual_review_agent is not None:
            ...
            async def _review_callback(
                ...
                return await visual_review_agent.process(
                    user_input=user_input,
                    output_mode=request_config.output_mode,
