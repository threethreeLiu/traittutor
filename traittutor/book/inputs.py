...
Reuses:
- ``traittutor.services.session.get_sqlite_session_store`` for chat history
- ``traittutor.services.notebook.notebook_manager`` for notebook records
- ``traittutor.agents.notebook.NotebookAnalysisAgent`` for context distillation
"""
