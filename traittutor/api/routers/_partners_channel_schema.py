...
Why live here vs inside ``traittutor.partners.channels``?
...
from traittutor.services.partners.manager import _is_secret_field
...
def all_channel_schemas() -> dict[str, dict[str, Any]]:
    ...
    """
    from traittutor.partners.channels.registry import discover_all_with_errors
