...
from traittutor.learning import policy as learning_policy
from traittutor.learning import prompts as learning_prompts
...
async def generate_from_notebook(book_id: str, body: GenerateFromNotebookRequest):
    ...
    from traittutor.services.llm import complete
