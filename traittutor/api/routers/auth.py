...
class RegisterRequest(BaseModel):
    ...
    def username_valid(cls, v: str) -> str:
        ...
        if not re.fullmatch(r"[A-Za-z0-9][A-Za-z0-9._-]{2,63}", v):
            raise ValueError("Username must use 3-64 letters, numbers, dots, underscores, or hyphens")
        return v
...
async def bootstrap_status() -> dict:
    ...
    configured = bool(INITIAL_ADMIN_USERNAME and INITIAL_ADMIN_PASSWORD) or bool(INITIAL_ADMIN_BOOTSTRAP_TOKEN)
