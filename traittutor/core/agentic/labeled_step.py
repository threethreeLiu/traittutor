...
from traittutor.core.agentic.usage import (
    UsageTracker,
...
from traittutor.services.llm.multimodal import should_degrade_to_text, strip_image_parts_inplace
from traittutor.services.llm.request_compat import (
...
async def run_labeled_step(  # noqa: C901 — single-pass streaming step protocol; the tool-dispatch
    # sub-loop extraction is a tracked dedicated task (needs WS protocol
    # e2e before/after). The C901 gate itself stays active at 40 for all
    # new code.
    *,
    client: Any,
    model: str | None,
