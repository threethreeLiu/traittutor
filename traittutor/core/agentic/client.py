...
from traittutor.services.llm import get_token_limit_kwargs, supports_tools
...
def _build_anthropic_adapter(config: LLMClientConfig, spec: Any) -> Any:
    from traittutor.services.llm.provider_core import AnthropicProvider
...
def _build_codex_adapter(config: LLMClientConfig, spec: Any) -> Any:
    from traittutor.services.llm.provider_core import OpenAICodexProvider
...
def _build_copilot_adapter(config: LLMClientConfig, spec: Any) -> Any:
    from traittutor.services.llm.provider_core import GitHubCopilotProvider
