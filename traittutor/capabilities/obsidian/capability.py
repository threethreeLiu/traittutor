...
vault (resolved by :mod:`traittutor.capabilities.obsidian.binding`). As a
...
from traittutor.capabilities.obsidian.binding import obsidian_vault_refs, vault_for_turn
from traittutor.capabilities.obsidian.tools import OBSIDIAN_TOOL_NAMES
...
class ObsidianCapability(KnowledgeCapability):
    ...
    def system_block(
        ...
        *,
        ...
        if binding is None:
            return None
        override = nested_prompt_text(prompts, ("obsidian", "system"))
...
def _load_system_prompt(language: str) -> str:
    ...
    prompt = asset_path("capabilities", "obsidian", lang, "system.md")
