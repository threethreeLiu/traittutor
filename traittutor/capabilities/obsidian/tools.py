...
:class:`~traittutor.capabilities.obsidian.capability.ObsidianCapability`, which
...
:mod:`traittutor.capabilities.obsidian.vault` operations.
...
from traittutor.capabilities.obsidian import vault as vault_ops
