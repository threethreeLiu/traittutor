...
:class:`traittutor.capabilities.solve.capability.DeepSolveCapability`.
"""
...
from traittutor.capabilities.solve.session import DEFAULT_MAX_REPLANS, get_session
from traittutor.capabilities.solve.tools import SOLVE_TOOL_NAMES
    ...
    def system_block(
        ...
        *,
        ...
        if not self.is_active(context):
            return None
        override = nested_prompt_text(prompts, ("solve", "system"))
...
def _load_system_prompt(language: str) -> str:
    ...
    prompt = asset_path("capabilities", "solve", lang, "system.md")
