...
from traittutor.api.routers.mastery_path import router
...
def app(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "traittutor.api.routers.mastery_path.LearningStore",
...
class TestGenerateFromNotebook:
    ...
    @patch("traittutor.services.llm.complete", new_callable=AsyncMock)
    ...
    @patch("traittutor.api.routers.mastery_path.get_ui_language", return_value="en")
    @patch("traittutor.services.llm.complete", new_callable=AsyncMock)
    ...
    @patch("traittutor.api.routers.mastery_path.get_ui_language", return_value="zh")
    @patch("traittutor.services.llm.complete", new_callable=AsyncMock)
