...
Unified LLM service for all TraitTutor modules.
...
Usage:
    ...
    from traittutor.services.llm import complete, stream
    ...
    # Configuration
    from traittutor.services.llm import get_llm_config, LLMConfig
    config = get_llm_config()

    # URL utilities for local LLM servers
    from traittutor.services.llm import sanitize_url, is_local_llm_server
"""
