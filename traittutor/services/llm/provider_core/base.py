...
class LLMResponse:
    ...
    # Raw image parts (``{"url": ...}``) when the model answered with image
    # modalities. Empty for every ordinary text completion.
...
class LLMProvider(ABC):
    ...
    async def _call_with_retry(
        ...
        **kwargs: Any,
        ...
        from traittutor.services.llm.multimodal import (
            has_image_parts,
            strip_image_parts,
