...
TraitTutor runs on the same machine as the user's configured agent CLIs — Claude
...
from traittutor.services.subagent.partner import PARTNER_BACKEND_KIND
from traittutor.services.subagent.registry import detect_all, get_backend, list_backend_kinds
