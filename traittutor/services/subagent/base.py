...
from traittutor.services.subagent.types import ConsultResult, DetectResult, SubagentEvent
...
class SubagentBackend(ABC):
    ...
    async def consult(
        ...
        *,
        ...
        subagent keeps context across TraitTutor's successive questions); the
