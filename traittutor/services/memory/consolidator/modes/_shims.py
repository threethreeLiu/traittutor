"""Legacy public-API shims for :mod:`traittutor.services.memory.store`.
...
from traittutor.services.memory.consolidator.modes.update import (
    UpdateResult,
    run_update,
)
from traittutor.services.memory.document import parse, serialize
from traittutor.services.memory.ops import ApplyReport, Op
