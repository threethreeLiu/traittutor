...
* :class:`ConsolidateResult`, :data:`OnEvent` — legacy types preserved
  for :mod:`traittutor.services.memory.store`.
...
from traittutor.services.memory.consolidator.guards import _filter_banned, _has_banned
from traittutor.services.memory.consolidator.modes import (
    consolidate_l2,
    consolidate_l3,
    run_audit,
    run_dedup,
...
from traittutor.services.memory.consolidator.parse import _parse_ops_response
