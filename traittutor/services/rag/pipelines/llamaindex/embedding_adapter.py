"""LlamaIndex embedding adapter backed by TraitTutor's embedding service."""
...
from traittutor.services.embedding import EmbeddingConfig, get_embedding_client, get_embedding_config
from traittutor.services.embedding.validation import validate_embedding_batch
...
class CustomEmbedding(BaseEmbedding):
    """Custom LlamaIndex embedding adapter for TraitTutor embedding providers."""
...
def configure_llamaindex_settings(logger=None) -> None:
    """Configure LlamaIndex globals for TraitTutor's current embedding config."""
