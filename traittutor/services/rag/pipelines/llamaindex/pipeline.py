...
class LlamaIndexPipeline:
    ...
    def _embedding_mismatch_warning(self, kb_name: str) -> str:
        try:
            ...
            kb_entry = (
                KnowledgeStateStore(Path(self.kb_base_dir))
                .load_config()
                .get("knowledge_bases", {})
                .get(kb_name, {})
            )
    ...
    async def add_documents(self, kb_name: str, file_paths: List[str], **kwargs) -> bool:
        ...
        try:
            ...
            existing_storage = plan.existing_storage
            if existing_storage is not None:
                ...
                num_added = await loop.run_in_executor(
                    None,
                    lambda: storage.insert_documents(existing_storage, plan.storage_dir, documents),
                )
