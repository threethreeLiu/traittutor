...
from traittutor.services.file_io import atomic_write_json as _atomic_write_json
...
# TraitTutor's legacy text extractors for PDF / Office / text-like files.
...
class RuntimeSettingsService:
    ...
    def _normalize_auth(self, settings: dict[str, Any]) -> dict[str, Any]:
        return {
            ...
            "allow_public_registration": _coerce_bool(settings.get("allow_public_registration"), False),
        }
