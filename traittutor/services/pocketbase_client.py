...
Usage:
    from traittutor.services.pocketbase_client import get_pb_client, is_pocketbase_enabled
...
from traittutor.services.config import load_integrations_settings
