    ...
    def is_ready(self, config: PyMuPDF4LLMConfig) -> ReadinessReport:
        if not self.is_available():
            return ReadinessReport(
                ...
                message="pymupdf4llm isn't installed (pip install traittutor[parse-pymupdf4llm]).",
            )
    ...
    def parse(
        ...
        *,
        ...
        try:
            ...
            raise ParserError(f"PyMuPDF4LLM failed to convert {source_path.name}: {exc}") from exc
