...
stage. An engine turns bytes/path into a :class:`~traittutor.services.parsing.types.ParsedDocument`
...
class Parser(Protocol):
    ...
    def parse(
        ...
        *,
        ...
        workdir via :func:`traittutor.services.parsing.cache.load_ir` and writes
