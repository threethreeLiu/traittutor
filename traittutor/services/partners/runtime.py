...
from traittutor.partners.helpers import detect_image_mime
from traittutor.services.partners.commands import PartnerCommandHandler
from traittutor.services.partners.scope import partner_user
from traittutor.services.partners.sessions import PartnerSessionStore
from traittutor.services.partners.workspace import ensure_partner_workspace, read_soul
...
class PartnerRunner:
    ...
    def _build_context(self, msg: InboundMessage) -> UnifiedContext:
        ...
        metadata: dict[str, Any] = {
            ...
            # Swaps the system prompt's product identity ("You are TraitTutor")
