# 🔧 TraitTutor v0.4.1 Release Notes
...
**Removed `traittutor/core` module** - All functionality migrated to `traittutor/services`:

| Old Import | New Import |
|:---|:---|
| `from traittutor.core.core import load_config_with_main` | `from traittutor.services.config import load_config_with_main` |
| `from traittutor.core.llm_factory import llm_complete` | `from traittutor.services.llm import complete` |
| `from traittutor.core.prompt_manager import get_prompt_manager` | `from traittutor.services.prompt import get_prompt_manager` |
| `from traittutor.core.logging import get_logger` | `from traittutor.logging import get_logger` |
...
**Full Changelog**: https://github.com/<your-org>/TraitTutor/compare/v0.4.0...v0.4.1
