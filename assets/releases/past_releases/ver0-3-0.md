# 🚀 TraitTutor v0.3.0 Release Notes

**Release Date:** January 6, 2026

We're excited to announce TraitTutor v0.3.0! This release focuses on **developer experience improvements**, **CI/CD automation**, and **simplified local deployment**.
...
docker run -d --name traittutor \
  -p 8001:8001 -p 3782:3782 \
  --env-file .env \
  -v $(pwd)/data:/app/data \
  ghcr.io/<your-org>/traittutor:latest### 🏠 Local-First LLM Configuration
...
This aligns with TraitTutor's vision for privacy-first, self-hosted AI tutoring.

## 📦 What's Changed

### Core Infrastructure

- Added `traittutor/core/prompt_manager.py` with singleton `PromptManager`
- Export `get_prompt_manager()` from `traittutor/core/__init__.py`
...
- Deleted `traittutor/agents/solve/utils/prompt_loader.py`
...
docker pull ghcr.io/<your-org>/traittutor:latest*Closes #33*
## What's Changed
* fix(UI): unrendered markdown in ActivityDetail card by @tusharkhatriofficial in https://github.com/<your-org>/TraitTutor/pull/26
* chore: transtale readme to ru by @oshliaer in https://github.com/<your-org>/TraitTutor/pull/27
* fix: improve reload_excludes configuration for uvicorn server and added support for newer models (openai) by @LouisACR in https://github.com/<your-org>/TraitTutor/pull/28
* feat: Dynamic LLM Provider Support (Local & Cloud) by @ahmedjawedaj in https://github.com/<your-org>/TraitTutor/pull/34

## 🤝New Contributors
* @oshliaer made their first contribution in https://github.com/<your-org>/TraitTutor/pull/27
* @LouisACR made their first contribution in https://github.com/<your-org>/TraitTutor/pull/28
* @ahmedjawedaj made their first contribution in https://github.com/<your-org>/TraitTutor/pull/34
