# TraitTutor v1.2.3 Release Notes
...
Two new `traittutor notebook` sub-commands let users add or replace Markdown content in a notebook record directly from the terminal, useful for scripted workflows and CI pipelines.
...
**Full Changelog**: https://github.com/<your-org>/TraitTutor/compare/v1.2.2...v1.2.3
