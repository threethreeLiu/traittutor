# TraitTutor v1.2.1 Release Notes
...
- **CLI** — `/regenerate` (alias `/retry`) inside the `traittutor chat` REPL.
...
**Full Changelog**: https://github.com/<your-org>/TraitTutor/compare/v1.2.0...v1.2.1
