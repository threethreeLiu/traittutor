# TraitTutor v1.4.10 Release Notes
...
### Run TraitTutor in a container, rootless-ready

A new [CONTAINERIZATION.md](https://github.com/<your-org>/TraitTutor/blob/main/CONTAINERIZATION.md)
...
per-request access log is now disabled on **every** launch path (`traittutor
...
Drop-in from v1.4.9: `pip install -U traittutor`; Docker users pull
`ghcr.io/<your-org>/traittutor:latest`. No migrations, no configuration changes.
...
**Full Changelog**: https://github.com/<your-org>/TraitTutor/compare/v1.4.9...v1.4.10
