# TraitTutor v1.3.1 Release Notes
...
- **Selected KB is now trusted system state** - chat RAG calls no longer let the
  LLM invent or override `kb_name`; the model only sees a `query`, and TraitTutor
...
- **Embedding responses are validated before use** - TraitTutor now rejects
...
**Full Changelog**: https://github.com/<your-org>/TraitTutor/compare/v1.3.0...v1.3.1
