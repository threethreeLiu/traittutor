# TraitTutor v1.4.3 Release Notes
...
[traittutor.info](https://traittutor.info/) have been rebuilt alongside —
...
[traittutor.info](https://traittutor.info/) was rebuilt with this release:
...
- `pip install -U traittutor` — the migrations run automatically on first
...
**Full Changelog**: https://github.com/<your-org>/TraitTutor/compare/v1.4.2...v1.4.3
