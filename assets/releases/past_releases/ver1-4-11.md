# TraitTutor v1.4.11 Release Notes
...
[CONTAINERIZATION.md](https://github.com/<your-org>/TraitTutor/blob/main/CONTAINERIZATION.md).
...
Drop-in from v1.4.10: `pip install -U traittutor`; Docker users pull
`ghcr.io/<your-org>/traittutor:latest`. No migrations, no configuration changes. The one
...
**Full Changelog**: https://github.com/<your-org>/TraitTutor/compare/v1.4.10...v1.4.11
