# TraitTutor v1.4.9 Release Notes
...
When TraitTutor grades a question inside a Mastery Path, the attempt — the
...
Drop-in from v1.4.8: `pip install -U traittutor`; Docker users pull
`ghcr.io/<your-org>/traittutor:latest`. No migrations, no configuration changes.

**Full Changelog**: https://github.com/<your-org>/TraitTutor/compare/v1.4.8...v1.4.9
