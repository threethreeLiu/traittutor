# TraitTutor v1.4.15 Release Notes
...
Drop-in from v1.4.14: `pip install -U traittutor`; Docker users pull `ghcr.io/<your-org>/traittutor:latest`. No migrations and no behavior changes — existing knowledge bases, partners, and mastery paths keep working as-is.

**Full Changelog**: https://github.com/<your-org>/TraitTutor/compare/v1.4.14...v1.4.15
