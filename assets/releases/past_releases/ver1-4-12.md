# TraitTutor v1.4.12 Release Notes
...
TraitTutor offloads retrieval to it over HTTP — no local index is built. Each KB
...
`pip install 'traittutor[parse-pymupdf4llm]'`; engines that need packages can now be
...
Drop-in from v1.4.11: `pip install -U traittutor`; Docker users pull
`ghcr.io/<your-org>/traittutor:latest`. No migrations. Existing LlamaIndex knowledge bases
...
**Full Changelog**: https://github.com/<your-org>/TraitTutor/compare/v1.4.11...v1.4.12
